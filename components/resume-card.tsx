    ...
    <Link href={href || "#"} className="block cursor-pointer" onClick={handleClick}>
      <Card className="flex bg-transparent">
        <div className="flex-none">
          <Avatar className="border size-12 m-auto bg-background dark:bg-foreground">
        ...
        <div className="grow ml-4 items-center flex-col group ">
          <CardHeader>
            <div className="flex items-center justify-between gap-x-2 text-base">
              ...
              <div className="text-xs sm:text-sm tabular-nums text-muted-foreground text-right shrink-0">{period}</div>
            </div>
